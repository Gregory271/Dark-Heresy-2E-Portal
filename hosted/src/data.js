...
export const scenes = [
  { id: "identity", eyebrow: "Character Creation", title: "Give the Character Life", copy: "Define the Acolyte's name, appearance, and other details that set the character apart from fellow Acolytes.", theme: "intake", action: "Continue", detailTitle: "Give the Character Life", detail: "Define the character's name, appearance, past, history with the Inquisitor, and other personal details." },
  { id: "homeWorld", catalog: "homeWorlds", eyebrow: "Choose Home World", title: "Choose Home World", copy: "The character's Home World is where the Acolyte was born and likely spent much of life. It shapes appearance, mannerisms, perspective, and starting characteristics.", theme: "forge", action: "Choose Home World", detailTitle: "Choose Home World", detail: "A Home World provides Characteristic Modifiers, Fate Threshold, a Home World Bonus, a Home World Aptitude, Wounds, and Recommended Backgrounds." },
  ...
  { id: "grants", eyebrow: "Starting Abilities", kicker: "Skills, Talents, and Traits", title: "Record Starting Abilities", copy: "Record the skills, talents, traits, and special abilities granted by the selected character-creation options.", theme: "assessment", action: "Continue", detailTitle: "Starting Abilities", detail: "Starting benefits are gained without spending the Acolyte's starting experience points. Resolve any alternatives before continuing." },
  { id: "equipment", eyebrow: "Equip Acolyte", kicker: "Armoury and Acquisitions", title: "Equip the Acolyte", copy: "Take the equipment granted by the Background, then select additional starting acquisitions equal to the Acolyte's Influence bonus.", theme: "assessment", action: "Continue", detailTitle: "Equip Acolyte", detail: "Additional starting acquisitions are normally limited to Scarce Availability or better. Weapons gained during character creation include two clips of standard ammunition." },
  { id: "advances", eyebrow: "Spend Starting XP", kicker: "1,000 Starting XP", title: "Purchase Advances", copy: "Spend experience points to improve characteristics, acquire or improve skills, and purchase talents or psychic powers.", theme: "assessment", action: "Review Acolyte", detailTitle: "Spend Experience Points", detail: "Advance costs depend on how many matching aptitudes the Acolyte possesses. Advances and skill ranks must be purchased in order, and prerequisites still apply." },
  { id: "review", eyebrow: "Character Creation", kicker: "Final Review", title: "Acolyte Ready", copy: "Review the completed character, resolve outstanding choices, and export the record for later editing or Foundry VTT.", theme: "assessment", action: "Export Character", detailTitle: "Review Character", detail: "The review verifies characteristics, Fate, Wounds, aptitudes, starting grants, acquisitions, and experience expenditure before export." },
];
