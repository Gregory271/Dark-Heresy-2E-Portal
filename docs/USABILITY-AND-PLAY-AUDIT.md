...
| Player makes a skill test | Click the skill cell itself; ordinary untrained skills apply -20, while Specialist skill families require a learned speciality | Searchable collapsed sections keep trained skills prominent, remove duplicate controls, and prevent illegal Specialist rolls |
